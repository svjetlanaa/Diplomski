...
public async Task<ActionResult<Product>> CreateProduct([FromForm] CreateProductDto productDto)
{
    ...
    if (productDto.File != null)
    {
        // Definišite putanju gde će se slike čuvati
        var desktopPath = Environment.GetFolderPath(Environment.SpecialFolder.Desktop);
        var imagesPath = Path.Combine(desktopPath, "C:\\Users\\pejic\\Desktop\\Kvadovi\\1.jpg");
        if (!Directory.Exists(imagesPath))
        {
            Directory.CreateDirectory(imagesPath);
        }

        var fileName = Path.GetFileName(productDto.File.FileName);
        ...
        product.Slika = Path.Combine("C:\\Users\\pejic\\Desktop\\Kvadovi\\1.jpg", fileName); // Putanja za prikaz
    }

    ...
    public class OrdersController : BaseApiController
    {
      ...
      [HttpGet("AllOrders")]
        public async Task<ActionResult<List<OrderDto>>> GetOrdersAll()
        {
         ...
         [HttpGet("Reservation")]
        public async Task<ActionResult<List<ReservationDto>>> Reservation()
        {
             var rezervisanaOprema = await _context.RezervisanaOprema.ToListAsync();

              return Ok(rezervisanaOprema);

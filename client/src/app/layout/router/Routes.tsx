...
import PregledRezervacije from "../../../features/admin/PregledRezervacije"
import Rezervacijakorisnika from "../../../features/checkout/rezervacijakorisnika"
import Profil from "../../../features/profilKorisnika/Profil"
...
export const router = createBrowserRouter([
    {
        ...
        children:[
            ...
            {element:<RequireAuth/>, children:[
                ...
                {path:'rezervacija', element:<Reservation/>},
                {path:'rezervacijaKorisnika', element:<Rezervacijakorisnika/>},
            ...
            {element:<RequireAuth roles={['Admin']}/>, children:[
                ...
                {path:'rezervacije', element:<PregledRezervacije/>},

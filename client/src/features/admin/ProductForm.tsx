    ...
    return (
        <Box component={Paper} sx={{p: 4}}>
            ...
            <Box display='flex' justifyContent='space-between' sx={{mt: 3}}>
                <Button onClick={cancelEdit} variant='contained' color='inherit'>Nazad</Button>
                <LoadingButton loading={isSubmitting}  type='submit' variant='contained' color='success'>Dodaj</LoadingButton>
            </Box>
            </form>
        </Box>
    )

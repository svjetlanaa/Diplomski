...
export default function PregledNarudzbe( {order, setSelectedOrder}: Props){
    ...
    return(
        ...
        <Box display='flex' justifyContent='space-between'>
            <Typography sx={{p:2}} gutterBottom variant="h4">Kupac# {order.bUyerId} -{order.orderStatus}</Typography>
        ...
        <BasketTable days={order.days} items={order.orderItems} isBasket={false} isOrder={true}/>
